...
<div class="page-container">
    <div class="left-content">
        <div class="inner-content">
                ...
                <div class="top_menu">
                    <div class="profile_details_left">
                        <div id="dd" class="wrapper-dropdown-3" tabindex="1">
                            <div class="wrapper-exit"><img src="../../images/exit.png" width="20px" style="margin-right: 7px;"><a
                                    href="/page/loginOut.html"><span>退出登录</span></a></div>
                        </div>
            ...
            <div class="outter-wp" style="height:654px">
                <iframe src="/query/Xs.html" frameborder="0" class="cjframe"></iframe>
            </div>
            <footer>
                <p>
