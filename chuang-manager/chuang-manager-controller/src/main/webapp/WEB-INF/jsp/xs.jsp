...
<div class="content">
    <table border="1" bordercolor="#000000" style="border-collapse:collapse;margin: 0 auto">
        ...
        <c:forEach items="${cj}" var="c" varStatus="vs">
            <c:if test="${((vs.index+1)%2==1) || (vs.first)}">
                <tr>
            </c:if>
            <td width="150px" id="kcm1" style="font-size:12px;text-align:left;white-space:nowrap;max-width: 150px">${c.kcm}</td>
            <%--<c:if test="${c.kcm.length() > 12}">--%>
                <%--<script>--%>
                    <%--// console.log("123");--%>
                    <%--var kcm = document.getElementById("kcm");--%>
                    <%--kcm.className = "small-font";--%>
                <%--</script>--%>
            <%--</c:if>--%>
            <script>
            ...
            <td width="40px" style="font-size: 12px">${c.xf}</td>
            <td width="65px" style="font-size: 12px;text-align: right">${c.cj}</td>
            <td width="40px" style="font-size: 12px">${c.xdfs}</td>
            <td width="40px" style="font-size: 12px">${c.kcsx}</td>
            <td width="60px" style="font-size: 12px">${c.kssj}</td>
            <c:if test="${((vs.index+1)%2==0) || (vs.last)}">
                </tr>
            </c:if>
